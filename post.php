...

{
   ...
   header("Location: post.php?p=$id&i=$i");
...
<body style="background-color: rgb(187, 187, 187);">
    ...
    <div class="main">
        ...
        <form action="post.php?p=<?= $p["idPostingan"];?>&act=submit" method="post">
        ...
        <input type="text" style="border: 0;" class="form-control" id="pilih" value="secreatmsg.epizy.com/post.php?p=<?= $id ;?>" readonly>
    ...
    <div class="pesan" style="margin-top: 0;">
        ...
        <a style="text-decoration:none;" href="komen.php?p=<?= $pesan["idPostingan"];?>&idP=<?= $pesan["idPesan"] ;?>">Balas Pesan atau lihat komentar</a>
